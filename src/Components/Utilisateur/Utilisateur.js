...
export default function Utilisateur() {
    ...
    const changeValeurDay = () => {
        setPeriode('Day')
        setMultiplicateur(7)
        setLastPeriod(5)
    }
    const changeValeurWeek = () => {
        setPeriode('Week')
        setMultiplicateur(32)
        setLastPeriod(36)
    }
    const changeValeurMonth = () => {
        setPeriode('Month')
        setMultiplicateur(635)
        setLastPeriod(542)
    }
