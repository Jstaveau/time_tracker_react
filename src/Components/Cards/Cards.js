...
export default function Cards(props) {
    return (
        <div className={'divCards arrondi w-100 mx-1 d-flex flex-column justify-content-end' + props.bg}>
            {props.img}
            <div className={'text-light height-cards-front w-100 bg-bleu-fonce arrondi'}>
                ...
                <h1 className='titre-cards mx-4 mt-4 fw-light'>32hrs</h1>
                <p className='text-desat mx-4'>Last Week - 36hrs</p>
            </div>
        </div>
    )
}
